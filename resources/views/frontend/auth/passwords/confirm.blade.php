...
<head>
    ...
    <title>{{ config('app.name', 'Portfolio') }} | {{ __('Confirm Password') }}</title>
    ...
    html.light-theme .confirm-text { color: #475569 !important; }
    ...
    .login-wrapper { width: 100%; max-width: 420px; z-index:1; padding-bottom: 40px; }
    .login-card {
    ...
    .login-input:focus {
        border-color:#00d9ff;
        box-shadow:0 0 0 5px rgba(0,217,255,0.2),0 0 20px rgba(0,217,255,0.15);
    ...
    .login-link {
        font-size:13px; color:#00d9ff; text-decoration:none;
        text-align:center; display:block;
    }
    .login-link::after {
        content:''; display:block; width:0; height:1px;
        background:#00d9ff; transition: width 0.3s ease; margin:2px auto 0;
    }
