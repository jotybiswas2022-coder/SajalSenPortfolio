            ...
            <div class="ae-page-header mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex flex-column align-items-start gap-1">
                        <div class="ae-title">Edit Case Study</div>
                        <p class="ae-sub">Update details for <strong style="color:#00d9ff;">{{ $caseStudy->title }}</strong>.</p>
                    </div>
                </div>
                            ...
                            <div>
                                @if($caseStudy->image)
                                    <div class="d-flex align-items-start gap-2">
                                        ...
                                        <button type="button" onclick="confirmDeleteImage()" class="ae-action-btn delete" title="Delete image">
