...
<div class="container-fluid py-3 testimonials-page">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold mb-1"><i class="bi bi-chat-quote me-2" style="color:#00d9ff;"></i>Testimonials</h4>
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="{{ route('admin.testimonials.create') }}" class="btn btn-primary rounded-3 px-3" style="background:#00d9ff; border-color:#00d9ff;">
    ...
    @if($testimonials->isEmpty() && !request()->ajax())
        <div class="text-center py-5">
            <div class="empty-state">
                ...
                <a href="{{ route('admin.testimonials.create') }}" class="btn btn-primary rounded-3 px-4" style="background:#00d9ff; border-color:#00d9ff;">
