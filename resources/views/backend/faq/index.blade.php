...
<style>
    ...
    @media (max-width: 767.98px) {
        ...
        .faq-table .c-num { display: none !important; }
        .faq-table tr > td:first-child:not(.c-question):not(.c-answer):not(.c-order):not(.c-status):not(.c-actions) { display: none !important; }
        .c-qnum {
            ...
            margin-right: 0.5rem; vertical-align: middle; align-self: flex-start;
        }
        ...
        .faq-table .c-status { margin-left: 0; }
