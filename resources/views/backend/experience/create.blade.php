            ...
            <div class="ae-page-header mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex flex-column align-items-start gap-1">
                        <div class="ae-title">Add Work Experience</div>
                        <p class="ae-sub">Add a new entry to your career timeline.</p>
                    </div>
                </div>
            ...
            <form action="{{ route('admin.experiences.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="end_date" id="end_date"
                                       ...
                                       value="{{ old('end_date') }}">
                                <div class="ae-note">Leave blank if currently working</div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="ae-btn ae-btn-primary">
                        <i class="bi bi-check-circle"></i> Create Experience
                    </button>
                </div>
