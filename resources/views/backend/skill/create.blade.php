            ...
            <div class="ae-page-header mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex flex-column align-items-start gap-1">
                        <div class="ae-title">Add a New Skill</div>
                        <p class="ae-sub">Add a new technical skill to your portfolio.</p>
                    </div>
                </div>
                    ...
                    <div class="ae-card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" name="percentage" id="skillPercentage" min="0" max="100"
                ...
                <div class="ae-card mb-4">
                    ...
                    <div class="ae-card-body text-center">
                        <div class="d-inline-flex align-items-center gap-3 p-3 rounded-3"
                            ...
                            <i class="bi {{ old('icon') ?: 'bi-star' }}" id="iconPreview" style="font-size:2rem;color:#00d9ff;text-shadow:0 0 12px rgba(0,217,255,0.4);"></i>
                            <div class="text-start">
                                ...
                                <div class="progress mt-1" style="width:180px;height:6px;border-radius:10px;background:rgba(0,217,255,0.1);">
                                    <div class="progress-bar rounded-pill" style="width:{{ old('percentage', 80) }}%;background:linear-gradient(90deg,#00d9ff,#7ce6ff);box-shadow:0 0 10px rgba(0,217,255,0.4);" id="previewBar"></div>
                                </div>
                            </div>
                            <span class="ae-status-badge" id="previewPercent">{{ old('percentage', 80) }}%</span>
                        </div>
                    </div>
                </div>
...
document.getElementById('skillPercentage').addEventListener('input', function() {
