            ...
            <div class="ae-page-header mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex flex-column align-items-start gap-1">
                        <div class="ae-title">Add New Service</div>
                        <p class="ae-sub">Create a new service to showcase what you offer.</p>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="title"
                                       ...
                                       value="{{ old('title') }}" placeholder="e.g. Penetration Testing" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="short_description" rows="3"
                                          ...
                                          placeholder="Brief description for the service card (max 500 chars)">{{ old('short_description') }}</textarea>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="icon" id="iconInput"
                                       ...
                                       value="{{ old('icon') }}" placeholder="e.g. bi-shield-lock">
                                ...
                                <div class="mt-3 d-flex align-items-center gap-3">
                                    <div class="ae-icon-box" style="width:56px;height:56px;font-size:1.6rem;">
                                        <i class="bi {{ old('icon') ?: 'bi-shield-lock' }}" id="iconPreview"></i>
                                    </div>
