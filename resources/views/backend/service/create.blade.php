    ...
    <div class="row justify-content-center">
        <div class="col-lg-9 col-md-11">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="fw-bold mb-1"><i class="bi bi-plus-circle me-2" style="color:#00d9ff;"></i>Add a New Service</h4>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="mt-2 d-flex align-items-center gap-2">
                                    ...
                                    <i class="bi {{ old('icon') ?: 'bi-star' }}" id="iconPreview" style="font-size:1.5rem; color:#00d9ff;"></i>
                                </div>
                            </div>
                            <div class="col-md-3">
